...
C     .. Intrinsic Functions ..
      ...
      INTEGER, INTENT(IN) :: NR,NA,M,N,IOPT,NPTQ
      DOUBLE PRECISION, INTENT(IN) :: EPS, U
      DOUBLE COMPLEX, INTENT(IN) :: C

C     .. Input Arrays ..
      DOUBLE COMPLEX, INTENT(IN) :: W0(30),W1(30),Z0(30),Z1(30)
      DOUBLE PRECISION, INTENT(IN) :: ALFA0(30),ALFA1(30),PHI0(30),
     +                                PHI1(30),QWORK(1660)
